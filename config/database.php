    ...
    'connections' => [
        ...
        'landlord' => match (env('LANDLORD_DB_DRIVER', 'mysql')) {
            'sqlite' => [
                ...
                'database' => ($path = env('LANDLORD_DB_DATABASE', 'landlord.sqlite'))
            ...
            default => [
                ...
                'database' => env('LANDLORD_DB_DATABASE', 'tamcarwash_landlord'),
        ...
        'tenant' => match (env('TENANT_DB_DRIVER', env('LANDLORD_DB_DRIVER', 'mysql'))) {
            'sqlite' => [
                'driver' => 'sqlite',
                'url' => env('TENANT_DB_URL'),
                'database' => env('TENANT_SQLITE_PLACEHOLDER', database_path('tenants/.gitkeep')),
                'prefix' => '',
                'foreign_key_constraints' => env('DB_FOREIGN_KEYS', true),
                'busy_timeout' => null,
                'journal_mode' => null,
