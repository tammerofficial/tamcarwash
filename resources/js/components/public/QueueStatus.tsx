            ...
            <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
                <div className="flex flex-col lg:flex-row items-end justify-between gap-10 mb-20">
                    ...
                    <div className="flex items-center gap-4 bg-white px-5 py-3 rounded-xl shadow-sm border border-gray-100/50 mx-auto lg:mx-0">
                        <div className="h-2.5 w-2.5 rounded-full bg-brand-secondary animate-pulse" />
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div>
                                            ...
                                            <Badge className={cn(
                                                ...
                                                branch.load > 50 ? "bg-amber-50 text-amber-700 border-amber-100" : "bg-brand-secondary-10 text-brand-primary border-brand-secondary-20"
                                            )}>
                                                {branch.status}
                                            </Badge>
                                        </div>
                                        ...
                                        <div className="h-1.5 w-full bg-gray-200/50 rounded-full overflow-hidden">
                                            <div 
                                                className={cn(
                                                    ...
                                                    branch.load > 70 ? "bg-amber-500" : "bg-brand-secondary"
                                                )}
