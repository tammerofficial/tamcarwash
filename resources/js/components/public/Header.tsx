            ...
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 lg:px-8">
                <Link to="/" className="flex items-center gap-3 group">
                    <div
                        className={cn(
                            ...
                            !logoUrl && 'bg-brand-primary text-white',
                        )}
                    >
                        {logoUrl ? (
                    ...
                    <div className="flex flex-col min-w-0">
                        <span className="text-lg font-bold tracking-tight text-brand-primary-dark truncate">
                            {businessName}
                        </span>
                        <span className="text-[11px] font-medium text-brand-primary/60 truncate">
                            {tagline}
                        </span>
                    </div>
                </Link>
                            ...
                            className={({ isActive }) =>
                                cn(
                                    ...
                                    isActive
                                        ...
                                        : 'text-slate-600 hover:text-brand-primary hover:bg-brand-primary/5',
                                )
                            }
                        >
                            {item.label}
                ...
                <div className="hidden items-center gap-4 lg:flex">
                    <a
                        ...
                        className="flex items-center text-[13px] font-semibold text-brand-primary/70 hover:text-brand-primary-dark transition-colors"
                    >
                    ...
                    {isAuthenticated ? (
                        <Button variant="ghost" size="sm" asChild className="font-semibold text-brand-primary/70 hover:text-brand-primary-dark hover:bg-brand-primary/5">
                    ...
                    <Button size="sm" asChild className="bg-brand-primary text-white hover:bg-brand-primary-dark rounded-full px-6 h-10 font-semibold shadow-sm transition-all">
            ...
            >
                <nav className="flex flex-col gap-1 p-5 overflow-y-auto h-full">
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-3">
                        {isAuthenticated ? (
                            <Button variant="outline" asChild className="rounded-xl h-12 font-bold border-brand-primary/20 text-brand-primary-dark">
                        ...
                        <Button asChild className="bg-brand-primary text-white hover:bg-brand-primary-dark rounded-xl h-12 font-bold shadow-sm">
                    ...
                    <a
                        href={`tel:${contactPhone}`}
                        className="mt-auto flex items-center justify-center gap-3 p-5 rounded-xl bg-brand-primary/5 text-brand-primary-dark font-bold hover:bg-brand-primary/10 transition-colors"
                    >
