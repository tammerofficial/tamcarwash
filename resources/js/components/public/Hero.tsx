...
export function PublicHero({ profile, featuredService }: PublicHeroProps) {
    ...
    return (
        <section className="relative overflow-hidden bg-slate-50" dir="rtl">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="space-y-8 order-2 lg:order-1">
                            ...
                            <div className="inline-flex items-center gap-2.5 rounded-full border border-slate-200 bg-white px-4 py-2 shadow-sm">
                                ...
                                <span className="text-sm font-bold text-slate-900">{announcement}</span>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-6">
                                <Button size="lg" asChild className="h-14 px-8 rounded-xl text-base font-bold bg-slate-900 text-white hover:bg-slate-800 transition-all shadow-md">
                                    <Link to="/book">
                                        <CalendarDays className="me-2 h-5 w-5" />
                                        احجز الآن
                                    </Link>
                                </Button>
                                <Button size="lg" variant="outline" asChild className="h-14 px-8 rounded-xl text-base font-bold border-slate-200 text-slate-900 hover:bg-slate-100 transition-all shadow-sm bg-white">
                                    <Link to="/queue">
                            ...
                            <div className="grid grid-cols-3 gap-4 pt-8">
                                <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm">
                                    ...
                                    <p className="text-xs font-semibold text-slate-500 mt-2">خدمة متنوعة</p>
                                </div>
                                <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm">
                                    <p className="text-3xl font-black text-slate-900">
                                        {profile?.stats?.branches ?? '—'}
                                    </p>
                                    <p className="text-xs font-semibold text-slate-500 mt-2">فروع موزعة</p>
                                </div>
                                <a href={`tel:${contactPhone}`} className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm hover:bg-slate-50 transition-colors">
                                    <p className="text-lg font-black text-slate-900 leading-tight">{contactPhone}</p>
                                    <p className="text-xs font-semibold text-slate-500 mt-2">تواصل</p>
                                </a>
                            </div>
                        </div>
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-2 shadow-xl">
                                    <div className="relative overflow-hidden rounded-2xl aspect-[3/4]">
                                        ...
                                        <div className="absolute bottom-6 inset-x-6 rounded-xl bg-white/95 p-5 shadow-lg backdrop-blur-sm border border-slate-100">
                                            <div className="flex items-center gap-4">
                                                <div className="h-14 w-14 rounded-lg bg-slate-100 flex items-center justify-center text-slate-900 shrink-0">
                                                    <Sparkles className="h-6 w-6" />
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    <p className="font-bold text-slate-900 truncate text-sm">{featuredName}</p>
                                                    <p className="text-xs font-semibold text-slate-500 mt-1">
                                                        يبدأ من {formatPrice(featuredPrice, currency)}
                                                    </p>
                                                </div>
                                                <Button size="sm" asChild className="bg-slate-900 text-white hover:bg-slate-800 h-10 px-5 rounded-lg shadow-sm font-bold text-xs">
                                        ...
                                        <div className="absolute top-6 inset-x-6 flex gap-2 justify-end">
                                            <div className="px-3 py-1.5 rounded-lg bg-white/90 backdrop-blur-sm border border-slate-200 flex items-center gap-1.5 text-xs font-bold text-slate-900 shadow-sm">
