...
const featureIcons: Record<string, typeof CalendarDays> = {
...
export function PricingPage() {
    const trustPoints = [
        { text: 'مجاني بالكامل للأبد', icon: Gift },
        { text: 'لا رسوم خفية أو عمولات', icon: ShieldCheck },
        { text: 'دعم فني متميز ومجاني', icon: Headphones },
    ];
            ...
            <main className="relative overflow-hidden pt-32 lg:pt-40">
                    ...
                    <div className="mx-auto max-w-5xl text-right">
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <span className="inline-flex items-center gap-2 rounded-full border border-brand-primary/20 bg-white/70 px-4 py-2 text-xs font-bold uppercase tracking-[0.28em] text-brand-primary shadow-sm backdrop-blur-xl">
                                <Gift className="size-3.5 text-icon-dark" />
                                استثمارك صفر
                            </span>
                        </div>
                ...
                <section className="relative z-10 px-6 py-20 lg:px-8 lg:py-32">
                    <div className="mx-auto max-w-4xl">
                        <div className="relative overflow-hidden rounded-[3rem] border border-brand-primary/15 bg-white/80 p-12 text-center shadow-3xl backdrop-blur-2xl sm:p-20">
                            <div className="absolute inset-0 bg-gradient-to-br from-brand-primary/5 to-white -z-10" />
                            <div className="absolute top-0 right-0 p-8">
                                <Badge className="rounded-full bg-gradient-to-br from-brand-primary to-brand-secondary px-4 py-2 text-xs font-bold uppercase tracking-[0.32em] text-white shadow-lg shadow-brand-primary/20">
                                    متاح الآن
                                </Badge>
                            </div>

                            <div className="mb-12">
                                <div className="mx-auto mb-6 marketing-icon-box-lg">
                                    <Sparkles className="size-10" />
                                </div>
                                <h3 className="text-3xl font-black tracking-tight text-aquatic-gradient sm:text-4xl">
                                    باقة النخبة
                                </h3>
                                <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-brand-primary/70">
                            ...
                            <div className="mb-12 border-y border-brand-primary/15 py-12">
                                <div className="flex flex-col items-center justify-center gap-4">
                                    ...
                                    <span className="text-xl font-black text-brand-secondary uppercase tracking-[0.3em] sm:text-2xl">
                                        ر.ع / للأبد
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="grid gap-6 sm:grid-cols-2 text-right mb-12">
                                {[
                                    ...
                                    const FeatureIcon = featureIcons[featureKey] ?? CheckCircle2;
                                    return (
                                        <div key={featureKey} className="flex items-center justify-end gap-4 p-4 rounded-2xl bg-white border border-brand-primary/15 shadow-sm hover:border-brand-primary/30 transition-colors">
                                            ...
                                            <div className="marketing-icon-box-sm !size-10 shrink-0">
                            ...
                            <p className="mt-8 text-xs font-bold text-brand-primary/50 uppercase tracking-widest">
                    ...
                    <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-stretch">
                        <div className="rounded-[2.5rem] border border-brand-secondary/20 bg-white/70 p-10 shadow-sm backdrop-blur-xl lg:p-14">
                            <div className="inline-flex items-center gap-2 rounded-full border border-brand-primary/10 bg-brand-primary/5 px-4 py-2 text-xs font-bold uppercase tracking-[0.35em] text-brand-primary shadow-sm">
                                <HelpCircle className="size-4 text-icon-dark" />
                                الأسئلة الشائعة
                            </div>
                            <h2 className="mt-8 text-3xl font-black tracking-tight text-aquatic-gradient sm:text-4xl">
                        ...
                        <Accordion type="single" collapsible className="space-y-4">
                            {[1, 2, 3].map((i) => (
                                ...
                                >
                                    <AccordionTrigger className="py-8 text-right text-base font-black text-brand-primary hover:no-underline data-[state=open]:text-brand-secondary">
                                    ...
                                    <AccordionContent className="pb-8 text-right text-base leading-relaxed text-brand-primary/70">
