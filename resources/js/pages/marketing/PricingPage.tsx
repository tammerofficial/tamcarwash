        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-600 selection:bg-brand-primary selection:text-white" dir="rtl">
            ...
            <main className="relative overflow-hidden pt-32 lg:pt-40">
                ...
                <div className="absolute inset-0 -z-10 overflow-hidden">
                    <div className="absolute top-0 right-0 size-[600px] rounded-full bg-cyan-100/30 blur-[120px]" />
                    <div className="absolute bottom-0 left-0 size-[500px] rounded-full bg-sky-100/20 blur-[100px]" />
                </div>
                ...
                <section className="relative z-10 px-6 py-20 lg:px-8 lg:py-32">
                    <div className="mx-auto max-w-4xl">
                        <div className="relative overflow-hidden rounded-[3rem] border border-sky-100 bg-white/80 p-12 text-center shadow-3xl backdrop-blur-2xl sm:p-20">
                            <div className="absolute top-0 right-0 p-8">
                                <Badge className="rounded-full bg-brand-secondary px-4 py-2 text-[10px] font-black uppercase tracking-[0.32em] text-brand-primary">
                                    متاح الآن
                                </Badge>
                            </div>

                            <div className="mb-12">
                                <h3 className="text-5xl font-black tracking-tight text-slate-900 sm:text-6xl">
                                    باقة النخبة
                                </h3>
                            ...
                            <div className="mb-12 border-y border-slate-100 py-12">
                                <div className="flex flex-col items-center justify-center gap-4">
                                    <span className="text-[120px] font-black leading-none text-brand-primary tracking-tighter sm:text-[180px]">
                                        0
                                    </span>
                            ...
                            <div className="grid gap-6 sm:grid-cols-2 text-right mb-12">
                                {[
                                    ...
                                    <div key={featureKey} className="flex items-center justify-end gap-4 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm">
                                        <span className="text-base font-bold text-slate-700">
                                            {t(`marketing.features.${featureKey}.title`)}
                                        </span>
                                        <div className="flex size-7 shrink-0 items-center justify-center rounded-lg bg-emerald-500 text-white shadow-sm shadow-emerald-200">
                            ...
                            <Button
                                size="lg"
                                className="h-20 w-full max-w-md rounded-[2.5rem] bg-brand-primary text-xl font-black text-white transition-all hover:bg-brand-primary/90 hover:scale-[1.02] shadow-2xl shadow-brand-primary/20"
                                asChild
                            >
                ...
                <section className="relative z-10 px-6 py-20 lg:px-8 lg:py-32">
                    <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-stretch">
                        <div className="rounded-[2.5rem] border border-slate-200 bg-white/70 p-10 shadow-sm backdrop-blur-xl lg:p-14">
                        ...
                        <Accordion type="single" collapsible className="space-y-4">
                            {[1, 2, 3].map((i) => (
                                <AccordionItem
                                    key={i}
                                    value={`q${i}`}
                                    className="rounded-[2rem] border border-slate-200 bg-white/80 px-8 shadow-sm transition-all hover:bg-slate-50"
                                >
                                    <AccordionTrigger className="py-8 text-right text-xl font-black text-slate-900 hover:no-underline data-[state=open]:text-brand-primary">
                                        <div className="flex w-full items-center justify-end gap-4">
                                            <span>{t(`marketing.pricingPage.q${i}`)}</span>
                                            <HelpCircle className="size-6 text-brand-primary" />
                                        </div>
                                    </AccordionTrigger>
                                    <AccordionContent className="pb-8 text-right text-lg leading-relaxed text-slate-600">
