    ...
    return (
        <div className="min-h-screen marketing-surface font-sans text-brand-primary/70 selection:bg-brand-primary selection:text-white" dir="rtl">
            ...
            <main className="relative overflow-hidden pt-32 lg:pt-44">
                            ...
                            <div className="relative overflow-hidden rounded-[3rem] border border-white/40 bg-white/80 p-8 shadow-3xl backdrop-blur-xl md:p-10">
                                <div className="flex items-center justify-between border-b border-brand-primary/15 pb-8">
                                    <div className="text-right">
                                        ...
                                        <p className="mt-2 text-3xl font-black text-brand-primary">لوحة الثقة التشغيلية</p>
                                    </div>
                                    <div className="flex size-16 items-center justify-center rounded-3xl bg-gradient-to-br from-brand-primary to-brand-secondary text-white shadow-xl shadow-brand-primary/20">
                                        ...
                                        return (
                                            <div key={item.label} className="rounded-[2rem] border border-brand-primary/15 bg-white p-6 shadow-sm hover:border-brand-primary/30 transition-colors">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div className="text-right">
                                                        <p className="text-[10px] font-black uppercase tracking-[0.24em] text-brand-primary/50">{item.label}</p>
                                ...
                                <div className="mt-8 rounded-[2.5rem] border border-brand-primary/10 bg-gradient-to-br from-brand-primary/5 via-white to-brand-secondary/5 p-8 shadow-inner">
                                    <div className="flex items-center justify-between gap-4 border-b border-brand-primary/15 pb-6">
                                        <p className="text-[10px] font-black uppercase tracking-[0.28em] text-brand-primary/50">القيمة المضافة</p>
                                    ...
                                    <div className="mt-8 grid gap-4 sm:grid-cols-2">
                                        {[
                                            ...
                                            <div key={item} className="rounded-2xl border border-brand-primary/15 bg-white px-5 py-4 text-sm font-bold text-brand-primary/70 shadow-sm">
                                                {item}
                                            </div>
                                        ))}
                                    </div>
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-primary to-brand-secondary text-white shadow-xl shadow-brand-primary/20">
                                                <Icon className="size-7" />
                                            </div>
                                            <span className="text-[10px] font-black uppercase tracking-[0.28em] text-brand-primary/50">0{index + 1}</span>
                                        </div>
                                        <h3 className="mt-8 text-2xl font-black tracking-tight text-brand-primary">{item.title}</h3>
                    ...
                    <div className="mx-auto max-w-7xl rounded-[3.5rem] border border-brand-primary/15 bg-white/80 px-8 py-20 text-brand-primary shadow-xl backdrop-blur-xl md:px-20 md:py-24 overflow-hidden relative">
                        ...
                        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                            <div className="space-y-8 text-right">
                                ...
                                <h2 className="text-4xl font-black tracking-tight text-aquatic-gradient md:text-6xl">
                                    رؤية واضحة، إدارة هادئة، وننمو مستدام
                                </h2>
                                <p className="max-w-2xl text-xl leading-relaxed text-brand-primary/70">
                                ...
                                <div className="grid gap-6">
                                    {[
                                        ...
                                        <div key={item} className="flex items-center gap-4 rounded-2xl border border-white bg-white/90 p-5 shadow-sm">
                                            ...
                                            <p className="text-lg font-bold text-brand-primary/90">{item}</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
                ...
                <section className="relative z-10 px-6 py-24 lg:px-8 lg:py-32">
                    <div className="mx-auto max-w-5xl rounded-[3rem] border border-brand-primary/10 bg-white/80 p-12 text-center shadow-3xl backdrop-blur-2xl md:p-20">
                        <div className="mx-auto max-w-3xl space-y-8">
                            <h2 className="text-4xl font-black tracking-tight text-brand-primary md:text-6xl">
                                {t('marketing.cta.title')}
                            </h2>
                            <p className="text-xl leading-relaxed text-brand-primary/70">
                                {t('marketing.cta.subtitle', brand)}
                            </p>
                        </div>
                        <div className="mt-12 flex flex-col justify-center gap-6 sm:flex-row">
                            <Button size="lg" className="h-16 rounded-2xl bg-gradient-to-br from-brand-primary to-brand-secondary px-12 text-lg font-black text-white shadow-2xl shadow-brand-primary/20 hover:bg-brand-primary/90 hover:scale-[1.05] transition-all" asChild>
                                <Link to="/register">{t('marketing.cta.button')}</Link>
                            </Button>
                            <Button size="lg" variant="outline" className="h-16 rounded-2xl border-brand-secondary/25 bg-white px-12 text-lg font-bold text-brand-primary shadow-sm hover:bg-brand-primary/5 hover:border-brand-primary/50 transition-all" asChild>
